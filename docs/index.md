...
- [ADR 0004: bounded own-data contract snapshot boundary](adrs/adr-0004-bounded-own-data-contract-snapshot-boundary.md)
...
- [TDR 0003: bounded GPU contract snapshot policies](tdrs/tdr-0003-bounded-contract-snapshot-policies.md)
